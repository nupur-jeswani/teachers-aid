...
if semSelection == "Semester 1":
    examSelection = st.selectbox(
        ...
        options=["Physics (Unit Tests)", "Chemistry (Unit Tests)", "Maths (Unit Tests)", "Basic Electrical Engineering (Unit Tests)",
                 "Mechanics (Unit Tests)", "Physics (Semester Exam)", "Chemistry (Semester Exam)", "Maths (Semester Exam)", "Basic Electrical Engineering (Semester Exam)", "Mechanics (Semester Exam)"]
    )
...
if semSelection == "Semester 2":
    examSelection = st.selectbox(
        ...
        options=["Physics (Unit Tests)", "Chemistry (Unit Tests)", "Maths (Unit Tests)",
                 "C Programming (Unit Tests)", "Engineering Drawing (Unit Tests)", "Physics (Semester Exam)", "Chemistry Semester Exam)", "Maths (Semester Exam)",
                 "C Programming (Semester Exam)", "Engineering Drawing (Semester Exam)"]
    )

if deptSelection == "INFT" and semSelection == "Semester 3":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Engineering Mathematics III (Unit Tests)", "Data Structure and Analysis (Unit Tests)", "Database Management System ( Unit Tests)", "Principle Of Communication ( Unit Tests)", "Paradigms and Computer programming Fundamentals (Unit Tests)",
                 "Engineering Mathematics III (Semester Exam)", "Data Structure and Analysis (Semester Exam)", "Database Management System (Semester Exam)", "Principle Of Communication (Semester Exam)", "Paradigms and Computer programming Fundamentals (Semester Exam)"]
    )

if deptSelection == "INFT" and semSelection == "Semester 4":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Engineering Mathematics-IV (Unit Tests)", "Computer Network and Network Design (Unit Tests)", "Operating System (Unit Tests)", "Automata Theory (Unit Tests)", "Computer Organization and Architecture (Unit Tests)",
                 "Engineering Mathematics-IV (Semester Exam)", "Computer Network and Network Design (Semester Exam)", "Operating System (Semester Exam)", "Automata Theory (Semester Exam)", "Computer Organization and Architecture (Semester Exam)"]
    )

if deptSelection == "CMPN" and semSelection == "Semester 3":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Discrete structure & graph theory (Unit Tests)", "Digital logic & computer architecture (Unit Tests)", "Computer graphics (Unit Tests)", "Data structure (Unit Tests)", "Engineering mathematics (Unit Tests)",
                 "Discrete structure & graph theory (Semester Exam)", "Digital logic & computer architecture (Semester Exam)", "Computer graphics (Semester Exam)", "Data structure (Semester Exam)", "Engineering mathematics (Semester Exam)"]
    )

if deptSelection == "CMPN" and semSelection == "Semester 4":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Engineering mathematics (Unit Tests)", "Database management system (Unit Tests)", "Operating system (Unit Tests)", "Microprocessor (Unit Tests)", "Analysis of algorithm (Unit Tests)",
                 "Engineering mathematics (Semester Exam)", "Database management system (Semester Exam)", "Operating system (Semester Exam)", "Microprocessor (Semester Exam)", "Analysis of algorithm (Semester Exam)"]
    )

if deptSelection == "EXTC" and semSelection == "Semester 3":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Applied mathematics-III (Unit Tests)", "Digital Logic Design (Unit Tests)", "Electronic Devices and Circuits (Unit Tests)", "Electrical Networks (Unit Tests)", "Electronic Instrumentation (Unit Tests)", "Presentation and Communication Technology (Unit Tests)",
                 "Applied mathematics-III (Semester Exam)", "Digital Logic Design (Semester Exam)", "Electronic Devices and Circuits (Semester Exam)", "Electrical Networks (Semester Exam)", "Electronic Instrumentation (Semester Exam)", "Presentation and Communication Technology (Semester Exam)"]
    )

if deptSelection == "EXTC" and semSelection == "Semester 4":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Applied Mathematics-IV (Unit Tests)", "Electronics and circuit Devices -II (Unit Tests)", "Electromagnetic Wave Theory (Unit Tests)", "Microprocessor and Microcontroller (Unit Tests)", "Signal And Systems (Unit Tests)", "Principle Of Control Systems (Unit Tests)",
                 "Applied Mathematics-IV (Semester Exam)", "Electronics and circuit Devices -II (Semester Exam)", "Electromagnetic Wave Theory (Semester Exam)", "Microprocessor and Microcontroller (Semester Exam)", "Signal And Systems (Semester Exam)", "Principle Of Control Systems (Semester Exam)"]
    )

if deptSelection == "ETRX" and semSelection == "Semester 3":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Applied Mathematics-III (Unit Tests)", "Electronic Devices and Circuits I (Unit Tests)", "Digital Circuit Design (Unit Tests)", "Electrical Network Analysis nd Synthesis (Unit Tests)", "Electronic Instruments And Measurements (Unit Tests)",
                 "Applied Mathematics-III (Semester Exam)", "Electronic Devices and Circuits (Semester Exam)", "Digital Circuit Design (Semester Exam)", "Electrical Network Analysis nd Synthesis (Semester Exam)", "Electronic Instruments And Measurements (Semester Exam)"]
    )

if deptSelection == "ETRX" and semSelection == "Semester 4":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Applied Mathematics IV (Unit Tests)", "Electronic Devices and Circuits (Unit Tests)", "Microprocessors And Applications (Unit Tests)", "Digital System Design (Unit Tests)", "Principle Of Communication Engineering (Unit Tests)", "Linear Control Systems (Unit Tests)",
                 "Applied Mathematics IV (Semester Exam)", "Electronic Devices and Circuits (Semester Exam)", "Microprocessors And Applications (Semester Exam)", "Digital System Design (Semester Exam)", "Principle Of Communication Engineering (Semester Exam)", "Linear Control Systems (Semester Exam)"]
    )

if deptSelection == "INSTRU" and semSelection == "Semester 3":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Engineering Mathematics- III (Unit Tests)", "Transducers- I (Unit Tests)", "Analog Electronics (Unit Tests)", "Digital Electronics (Unit Tests)", "Electrical Networks and Measurements (Unit Tests)", "Object Oriented Programing (Unit Tests)",
                 "Engineering Mathematics- III (Semester Exam)", "Transducers- I (Semester Exam)", "Analog Electronics (Semester Exam)", "Digital Electronics (Semester Exam)", "Electrical Networks and Measurements (Semester Exam)", "Object Oriented Programing (Semester Exam)"]
    )

if deptSelection == "INSTRU" and semSelection == "Semester 4":
    examSelection = st.selectbox(
        label="Select the type of examination and subject - ",
        options=["Engineering Mathematics- IV (Unit Tests)", "Transducers- II (Unit Tests)", "Signal Conditioning & Circuit Design (Unit Tests)", "Feedback Control Systems (Unit Tests)", "Control System Components (Unit Tests)", "Virtual Instrumentation (Unit Tests)",
                 "Engineering Mathematics- IV (Semester Exam)", "Transducers- II (Semester Exam)", "Signal Conditioning & Circuit Design (Semester Exam)", "Feedback Control Systems (Semester Exam)", " Control System Components (Semester Exam)", "Virtual Instrumentation (Semester Exam) "]
    )
...
st.markdown(f"<h6>Students having marks below 7 in {examSelection} - </h6>", True)
st.dataframe(data1)
...
with leftSide:
    ...
    st.markdown(f"<h6>Division - {df4.iloc[0]['CLASS AND SECTION']}</h6>", True)
